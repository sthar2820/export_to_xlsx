...
if uploaded_files:
    ...
    with st.expander("How it works"):
        ...
        1. **Auto-detects** SMITCH categories (S, M, I, T, C, H)
        2. **Finds** subcategory and data columns
        3. **Smart stop detection** for final columns (in priority order):
        ...
        **Supported final columns (in order of preference):**
        - "Demon-strated Rate at 100%" (highest priority)
        - "Demonstrated Rate at 100%"
        - "Baseline"
        - "Actual"
